...
const CourseDetailPage = () => {
  ...
  // Course-specific educational video URLs from reliable sources
  const courseVideos = {
    1: 'https://www.youtube.com/watch?v=nu_pCVPKzTk', // Web Dev Bootcamp (Traversy Media)
    2: 'https://www.youtube.com/watch?v=-ETQ97mXXF0', // Data Science Fundamentals
    3: 'https://www.youtube.com/watch?v=W6NZfCO5SIk', // Intro to JavaScript
    4: 'https://www.youtube.com/watch?v=R9I85RhI7Cg', // Advanced JS Concepts
    5: 'https://www.youtube.com/watch?v=c9Wg6Cb_YlU', // UI/UX Design Basics
    6: 'https://www.youtube.com/watch?v=nU-IIXBWlS4', // Digital Marketing Mastery
    7: 'https://www.youtube.com/watch?v=rfscVS0vtbw', // Python for Beginners
    8: 'https://www.youtube.com/watch?v=V7z7BAZdt2M', // Photography Fundamentals
    9: 'https://www.youtube.com/watch?v=mD0Dntx3R90', // Business Communication
  };

  const videoUrl = courseVideos[course.id] || courseVideos[1];
