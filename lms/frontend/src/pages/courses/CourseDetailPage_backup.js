...
const CourseDetailPage = () => {
  ...
  const courseData = {
    ...
    4: {
      ...
      students: 1850,
      price: 89.99,
      image: 'https://images.unsplash.com/photo-1579462904528-5c8ec2dc5645?w=800&h=400&fit=crop',
      category: 'Programming',
      icon: '⚡',
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={4}>
            <Card sx={{ position: 'sticky', top: 24 }}>
              <CardContent sx={{ p: 3 }}>
                <Typography variant="h4" sx={{ fontWeight: 800, color: '#3a86ff', mb: 2 }}>
                    ...
                    <Button
                      ...
                      sx={{
                        ...
                        background: course.isPaid 
                          ...
                          : 'linear-gradient(45deg, #10b981, #3a86ff)',
                        fontWeight: 600,
                      }}
                    >
                ...
                {isEnrolled && userProgress >= 100 && (
                  <Button
                    ...
                    sx={{
                      mb: 2,
                      py: 1,
                      background: course.certificateType === 'free' 
                        ? 'linear-gradient(45deg, #10b981, #3a86ff)'
                        : 'linear-gradient(45deg, #ffd700, #ff006e)',
                      fontWeight: 600,
                    }}
                  >
